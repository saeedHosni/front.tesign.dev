        ...
        <div className="reveal bg-bg-card border border-border-default rounded-xl p-[72px_60px] max-sm:p-12 max-sm:px-7 relative overflow-hidden text-center">
          ...
          <div className="flex gap-3 max-w-[520px] mx-auto flex-wrap relative z-[1]">
            <input
              ...
              dir="rtl"
              className={`flex-1 min-w-[200px] bg-bg-surface border rounded-md px-[18px] py-3.5 text-[0.9rem] font-vazir text-text-primary outline-none transition-all duration-300 focus:bg-[rgba(245,197,24,0.04)] focus:border-accent-yellow
            ...
            >
              {submitted ? '✓ ثبت شد!' : (<>ثبت پروژه <ArrowIcon /></>)}
            </Button>
          </div>
